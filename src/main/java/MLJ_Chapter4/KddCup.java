...
public class KddCup {
	...
	public static void main(String args[]) throws Exception {
		...
		EnsembleLibrary.saveLibrary(new File(KddCup.class.getResource("data/ensembleLib.model.xml").getFile()), ensembleLib, null);
	...
	public static double[] evaluate(Classifier model) throws Exception {
		...
		for (int i = 0; i < labelFiles.length; i++) {
			...
			// Load data
			Instances train_data = loadData(PATH_TO_DATA+"data/orange_small_train.data",
											PATH_TO_DATA+"data/orange_small_train_" + labelFiles[i]+ ".labels.txt");
